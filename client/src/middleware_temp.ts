...
//     if (!verify && isProtectedRoute) return NextResponse.redirect(`https://web-chat-app-2ksf.onrender.com/`);

//     if (verify && isPublicRoute) return NextResponse.redirect(`https://web-chat-app-2ksf.onrender.com/userdashboard`);
// }